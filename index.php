...
class wechatCallbackapiTest
{
    ...
    public function responseMsg()//设定回复的信息
    {
        ...
        function mynumber($astr) {
            return preg_replace('/\D/s','',$astr);
        }
	if (!empty($postStr)){
            ...
            //    echo dom_parser($html_source, "//li[@id='exlidResult0-LocationsTab']/a/@href");//获取图书所在位置
                ...
                $resultStr = sprintf($bilibili_xml, $fromUsername, $toUsername, $time,  $book_name, $contentStr, "", "http://115.28.1.228/a.php?isbn=" . $isbn);
                echo $resultStr;//
            }
        }   
        else{
